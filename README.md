...
* Solving using the Old Pochmann method, Beginner method, or Kociemba's Algorithm.
...
* Implementation of solving methods (Old Pochmann method, Beginner method, Kociemba's Algorithm) 
